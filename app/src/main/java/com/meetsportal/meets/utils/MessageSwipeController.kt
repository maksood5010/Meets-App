...
import com.meetsportal.meets.adapter.MeetChatAdapter.Companion.NOTIFY

class MessageSwipeController(private val context: Context, private val position: (Int)->Unit): ItemTouchHelper.Callback() {
    ...
    override fun getMovementFlags(recyclerView: RecyclerView, viewHolder: RecyclerView.ViewHolder): Int {
        ...
        imageDrawable = context.getDrawable(R.drawable.ic_reply_back)!!
        shareRound = context.getDrawable(R.drawable.ic_bg_share_round)!!
    ...
    override fun onChildDraw(
        ...
        if(viewHolder.itemViewType == NOTIFY)
            return
    ...
    private fun drawReplyButton(canvas: Canvas) {
        ...
        shareRound.colorFilter =
            PorterDuffColorFilter(ContextCompat.getColor(context, R.color.white), PorterDuff.Mode.MULTIPLY)
