...
import com.meetsportal.meets.ui.fragments.socialfragment.FollowingFragment
import com.meetsportal.meets.utils.Utils
import com.meetsportal.meets.utils.onClick
import com.meetsportal.meets.utils.verifyIcon

class FollowingPagerAdapter (var context : Activity, var fragment: FollowingFragment, var listener : (String?, Boolean)-> Unit, var openProfile : (String?)->Unit
) : PagingDataAdapter<FollowerFollowingResponseItem, FollowingPagerAdapter.RviewHolder>(
    FollowingPagerAdapter.COMPARATOR
) {
...
//        }
    ...
    private fun addClickevent(holder: RviewHolder, data: FollowerFollowingResponseItem?) {
